...
trackers = create_trackers('MovingBackgroundSubtraction'); % TODO: add more trackers here

labels = {'camera_motion', 'illum_change', 'occlusion', 'size', ...
    'motion', 'empty'};

context = create_report_context('report_MovingBackgroundSubtraction'); % TODO: name of the report
